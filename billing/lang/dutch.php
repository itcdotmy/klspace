...
$_LANG['affiliatesbullet1'] = "Ontvang een initieel bonus tegoed op uw affiliate account van";
...
$_LANG['affiliatesdescription'] = "Wordt lid van ons affiliate system of bekijk de verdiensten";
$_LANG['affiliatesdisabled'] = "Momenteel bieden we onze klanten geen affilate systeem aan.";
...
$_LANG['affiliateshostingpackage'] = "Hosting pakket";
$_LANG['affiliatesintrotext'] = "Activeer uw affiliate account vandaag voor:";
...
$_LANG['affiliatesreferallink'] = "Uw unieke affiliate link";
...
$_LANG['affiliateswithdrawalrequestsuccessful'] = "Uw verzoek om uitbetaling is in behandeling genomen, wij nemen spoedig contact met u op.";
...
$_LANG['bannedbanexpires'] = "Blokkering eindigd op";
...
$_LANG['cartconfigoptionsdesc'] = "Dit product of deze service heeft enkele opties, hieronder te kiezen, waarmee u uw bestelling kunt aanpassen.";
...
$_LANG['cartdomainsconfigdesc'] = "Hieronder kunt u uw domein namen in uw winkelwagen configureren en eventuele aanvullingen kiezen. Tevens kunt u verdere informatie opgeven zoals bijvoorbeeld de te gebruiken naamservers.";
...
$_LANG['cartnameserversdesc'] = "Als u eigen naamservers wilt gaan gebruiken dan kunt u deze hieronder opgeven. Standaard zullen nieuwe domeinen onze hosting naamservers van ons eigen netwerk gebruiken.";
$_LANG['cartproductaddons'] = "Product opties";
...
$_LANG['clientareaaddonorderconfirmation'] = "Bedankt. Uw bestelling is voor de onderstaande optie is geplaatst. Kies hieronder uw betalingswijze.";
...
$_LANG['clientareacancelconfirmation'] = "Bedankt, uw opheffingsaanvraag is verzonden. Was dit niet de bedoeling, neem dan direct contact met ons op.";
...
$_LANG['clientareacancelproduct'] = "Vraag opheffing aan voor";
$_LANG['clientareacancelreason'] = "Geef aub de reden waarom u wilt opzeggen";
$_LANG['clientareacancelrequest'] = "Account opheffing aanvraag";
$_LANG['clientareacancelrequestbutton'] = "Vraag opheffing aan";
$_LANG['clientareachangepassword'] = "Verander uw wachtwoord";
$_LANG['clientareachangesuccessful'] = "Uw informatie is geupdate";
...
$_LANG['clientareacontactsemailsdomain'] = "Domein emails - vernieuwing berichten, registratie bevestigingen, enz...";
...
$_LANG['clientareacontactsemailsproduct'] = "Product emails - order details, Welkomst emails, enz...";
$_LANG['clientareacontactsemailssupport'] = "Support emails - support ticket bevestigingen";
$_LANG['clientareacountry'] = "Land";
$_LANG['clientareacpanellink'] = "Login op uw cPanel";
...
$_LANG['clientareadeletecontact'] = "Wis contact";
$_LANG['clientareadeletecontactareyousure'] = "Weet u zeker dat u dit contact wil wissen ?";
...
$_LANG['clientareaemail'] = "Email adres";
$_LANG['clientareaemails'] = "Mijn emails";
$_LANG['clientareaemailsdate'] = "Verzonden";
$_LANG['clientareaemailsintrotext'] = "Hieronder staan alle support tickets die u bij ons heeft geopened.";
...
$_LANG['clientareaerrorbannedemail'] = "We accepteren geen gebruikers van de email provider die u heeft opgegeven. Geef aub een ander email adres op.";
...
$_LANG['clientareaerroremail'] = "U heeft uw email adres niet opgegeven";
...
$_LANG['clientareafullname'] = "Klantennaam";
$_LANG['clientareaheader'] = "Welkom bij ons klantensysteem waar u uw account bij ons kunt beheren. Deze pagina geeft een kort overzicht van uw account inclusief de eventueel openstaande support aanvragen en onbetaalde facturen.  Zorg er aub voor dat uw contact gegevens uptodate zijn.";
...
$_LANG['clientareaproducts'] = "Mijn producten &amp; services";
$_LANG['clientareaproductsnone'] = "Geen producten/services besteld";
...
$_LANG['clientareaupdateyourdetails'] = "Update uw gegevens";
...
$_LANG['clientareawebmaillink'] = "Login op uw webmail";
$_LANG['clientareawhmlink'] = "Login op het klantensysteem";
$_LANG['clientlogin'] = "Klanten Login";
$_LANG['clientregisterheadertext'] = "Vul aub alle onderstaande velden in het nieuwe account te registreren. Velden gemarkeerd met een * zijn verplicht.";
$_LANG['clientregistertitle'] = "Registreer";
$_LANG['clientregisterverify'] = "Verifieer registratie";
$_LANG['clientregisterverifydescription'] = "Neem de tekst die u in de afbeelding ziet over in het onderstaande tekstveld. Dit is vereist om automatische registraties te voorkomen.";
$_LANG['clientregisterverifyinvalid'] = "Incorrecte verificatie vode opgegeven";
...
$_LANG['contactheader'] = "Mocht u pre-sales vragen hebben of als u contact met ons op wilt nemen, dan kunt u hiervoor onderstaand formulier invullen.";
...
$_LANG['contacttitle'] = "Pre-sales contact";
...
$_LANG['domainbulksearch'] = "Bulk domein zoeker";
$_LANG['domainbulksearchintro'] = "De bulk realtime domeinnaam zoeker geeft u de mogelijkheid om tot 20 domeinen in één keer te zoeken.  Geef de domeinen in het onderstaande veld op, één per regel - geen www. of http:// vooraf opgeven aub.";
...
$_LANG['domaincurrentrenewaldate'] = "Huidige vernieuwingsdatum";
$_LANG['domaindnsaddress'] = "Adres";
$_LANG['domaindnshostname'] = "Hostnaam";
$_LANG['domaindnsmanagement'] = "DNS beheer";
$_LANG['domaindnsmanagementdesc'] = "Verwijs uw domein naar een website door het te koppelen aan een IP adres, of stuur het door naar een andere site, of verwijs naar een tijdelijke pagina (dit staat bekend als parkeren), en meer. Deze records staan ook bekend als subdomeinen.";
$_LANG['domaindnsrecordtype'] = "Record type";
$_LANG['domainemailforwarding'] = "Email doorsturing";
$_LANG['domainemailforwardingdesc'] = "Als de email forwarding server merkt dat het doorstuur-naar-adres ongeldig is, zullen we automatisch dit doorstuur record deactiveren. Controleer aub het doorstuur-naar-adres voordat u het opnieuw activeert. Wijzigingen op een bestaand doorstuur-record kunnen wel een uur op zich laten wachten.";
...
$_LANG['domaingeteppcodeexplanation'] = "De EPP code is eigenlijk het wachtwoord van een domeinnaam. Het is een beveiligingsmaatregel om er zeker van te kunnen zijn dat alleen de domeinnaam eigenaar een domein kan verhuizen. U heeft het nodig wanneer u een domein naar een andere registar wilt gaan verhuizen.";
...
$_LANG['domainorderrenew'] = "Bestel vernieuwing";
...
$_LANG['domainregisternsexplanation'] = "Hier kunt uw eigen naamservers voor uw domein aanmaken en beheren (bijv: NS1.uwdomein.com, NS2.uwdomein.com...).";
...
$_LANG['domainregisternsreg'] = "Registreer een naamserver naam";
...
$_LANG['domainrenew'] = "Domein vernieuwen";
$_LANG['domainrenewal'] = "Domein vernieuwing";
$_LANG['domainrenewalprice'] = "Vernieuwing";
$_LANG['domainrenewdesc'] = "Beveilig uw domein door meerdere jaren er aan toe te voegen. Kies hieronder voor hoeveel jaren u wilt gaan vernieuwen en klik dan op Order vernieuwing.";
$_LANG['domainsautorenew'] = "Automatische vernieuwing";
$_LANG['domainsautorenewdisable'] = "Deactiveer automatische vernieuwing";
$_LANG['domainsautorenewdisabled'] = "Gedeactiveerd";
$_LANG['domainsautorenewdisabledwarning'] = "WAARSCHUWING! Voor dit domein is de automatische vernieuwing gedeactiveerd.<br />Het zal na de huidige termijn verlopen en inactief worden tenzij het handmatig wordt vernieuwd.";
$_LANG['domainsautorenewenable'] = "Activeer automatische vernieuwing";
...
$_LANG['domainviewwhois'] = "Bekijk whois rapport";
...
$_LANG['email'] = "Email";
$_LANG['emptycart'] = "Winkelwagen leegmaken";
...
$_LANG['flashtutorialsdescription'] = "Klik hier om de handleidingen te zien die informatie geven hoe u uw hosting control panel dient te gebruiken.";
$_LANG['flashtutorialsheadertext'] = "Onze flash handleidingen staan hier om u te helpen om uw web hosting control panel volledig te kunnen gebruiken. Kies hieronder een taak om een stap-voor-stap handleiding te zien hoe u de taak kunt voltooien.";
...
$_LANG['go'] = "Ga";
$_LANG['headertext'] = "Welkom bij ons klantensysteem.";
$_LANG['hometitle'] = "Home";
$_LANG['imagecheck'] = "Geef aub de beveiligingscode op die in de afbeelding wordt weergegeven. Dit is vereist om automatische registraties te voorkomen.";
...
$_LANG['kbsuggestionsexplanation'] = "De volgende artikelen die in de kennisbank zijn gevonden geven mogelijk een antwoord op uw vraag. Geef aub een recensie aan de suggesties alvorens u deze opgeeft.";
...
$_LANG['loginforgotteninstructions'] = "Klik hier om het wachtwoord aan te vragen";
$_LANG['loginincorrect'] = "Login details zijn onjuist. Probeer het nog eens aub.";
$_LANG['loginintrotext'] = "U dient ingelogd te zijn om toegang tot deze pagina te kunnen krijgen. Deze login gegevens zijn niet gelijk aan de de gebruikersnaam en het wachtwoord van uw website control panel.";
...
$_LANG['maxmind_rejectemail'] = "We staan geen order toe die gebruik maken van een gratis email adres, probeer het nog eens en maak daarbij gebruik van een ander email adres";
$_LANG['maxmind_title'] = "MaxMind";
$_LANG['more'] = "Meer";
$_LANG['morechoices'] = "Meerdere keuzes";
$_LANG['networkissuesaffecting'] = "Beïnvloedingen";
$_LANG['networkissuesaffectingyourservers'] = "Let op: kwesties die invloed hebben op onze servers waar u uw accounts op heeft draaien zullen oplichtend en met een goudkleurige achtergrond worden weergegeven";
$_LANG['networkissuesdate'] = "Datum";
$_LANG['networkissuesdescription'] = "Lees over huidige en geagendeerde netwerk problemen";
$_LANG['networkissueslastupdated'] = "Laatste update";
$_LANG['networkissuesnonefound'] = "Geen netwerk kwesties gevonden";
...
$_LANG['networkissuestitle'] = "Netwerk kwesties";
...
$_LANG['no'] = "Nee";
$_LANG['nocarddetails'] = "In dit record bevinden zich geen bestaande kaart gegevens";
$_LANG['none'] = "Geen";
$_LANG['norecordsfound'] = "Geen records gevonden";
$_LANG['or'] = "of";
$_LANG['orderadditionalrequiredinfo'] = "Benodigde additionele informatie";
$_LANG['orderaddon'] = "Optie";
$_LANG['orderaddondescription'] = "De volgende opties zijn voor dit product beschikbaar. Kies hieronder te opties die u wilt bestellen.";
...
$_LANG['ordercodenotfound'] = "De opgegeven promotie code bestaat niet";
$_LANG['ordercompletebutnotpaid'] = "Opgelet! Uw order is voltooid maar er is nog niet voor betaald en het zal daarom nog niet geactiveerd worden.<br />Klik op onderstaande link om naar uw factuur te gaan en de betaling te doen.";
$_LANG['orderconfigpackage'] = "Configureerbare opties";
$_LANG['orderconfigure'] = "Configureer";
$_LANG['orderconfirmation'] = "Order bevestiging";
$_LANG['orderconfirmorder'] = "Bevestig order";
$_LANG['ordercontinuebutton'] = "Klik om door te gaan >>";
$_LANG['orderdesc'] = "Beschrijving";
$_LANG['orderdescription'] = "Plaats bij ons een nieuwe order";
...
$_LANG['orderdontusepromo'] = "Gebruik geen promotie code";
$_LANG['ordererroraccepttos'] = "U moet onze gebruiksvoorwaarden accepteren";
$_LANG['ordererrordomainalreadyexists'] = "De door u opgegeven domein is al door ons geregistreerd - u moet deze eerst annuleren alvorens u een nieuwe order kunt plaatsen";
$_LANG['ordererrordomaininvalid'] = "Het door u opgegeven domein is ongeldig";
$_LANG['ordererrordomainnotld'] = "U moet de domein TLD opgeven";
...
$_LANG['ordererrortransfersecret'] = "U moet de verhuizingscode opgeven";
$_LANG['ordererroruserexists'] = "Er bestaat al een gebruiker met dit email adres";
$_LANG['orderexistinguser'] = "Ik ben een bestaande klant en wil graag deze order aan mijn account toevoegen";
$_LANG['orderfailed'] = "Order is mislukt";
$_LANG['orderfinalinstructions'] = "Als u vragen over uw bestelling hebt dan kunt u een support ticket aanmaken in uw klantensysteem, vergeet hierbij niet uw ordernummer te vermelden.";
...
$_LANG['ordergotoclientarea'] = "Klik hier om naar uw klantensysteem te gaan";
...
$_LANG['orderlogininfopart2'] = "klantensysteem. Dit is niet gelijk aan uw gebruikersnaam &amp; wachtwoord van uw website control panel.";
...
$_LANG['ordernotes'] = "Opmerkingen / additionele informatie";
$_LANG['ordernotesdescription'] = "Hier kunt u additionele opmerkingen of informatie die u aan uw order wilt toevoegen plaatsen...";
...
$_LANG['orderpromoexpired'] = "De opgegeven promotie code is verlopen";
$_LANG['orderpromoinvalid'] = "De opgegeven promotie code is op geen enkel item in uw order van toepassing";
$_LANG['orderpromomaxusesreached'] = "De opgegeven promotie code is al gebruikt";
$_LANG['orderpromotioncode'] = "Promotie code";
$_LANG['orderpromovalidatebutton'] = "Validatie code >>";
...
$_LANG['ordersecure'] = "Dit orderformulier wordt in een beveiligde omgeving gepresenteert en om ons tegen fraude te beschermen wordt uw huidige IP adres";
$_LANG['ordersecure2'] = "geregistreerd.";
$_LANG['orderserverhostname'] = "Server hostnaam";
$_LANG['orderservernameservers'] = "Nameservers";
$_LANG['orderservernameserversdescription'] = "De voorvoegsels die u hier opgeeft bepalen de standaard naamservers van de server, bijv: ns1.uwdomein.com and ns2.uwdomein.com";
...
$_LANG['ordersummary'] = "Order overzicht";
$_LANG['ordertaxcalculations'] = "Btw berekeningen";
$_LANG['ordertaxstaterequired'] = "U moet uw staat opgeven ten behoeve van de Btw berekening";
$_LANG['ordertitle'] = "Order";
$_LANG['ordertos'] = "Gebruiksvoorwaarden";
$_LANG['ordertosagreement'] = "Ik heb ze gelezen en ga er mee akkoord";
$_LANG['ordertotalduetoday'] = "Verlopen totaal vandaag";
$_LANG['ordertotalrecurring'] = "Totaal herhalend";
$_LANG['ordertransferdomain'] = "Verhuis een bestaande domeinnaam";
$_LANG['ordertransfersecret'] = "Verhuizingscode";
$_LANG['ordertransfersecretexplanation'] = "Geef aub de verhuizingscode op, deze is bij de huidige Registar van de domeinnaam aan te vragen. ";
$_LANG['orderusesubdomain'] = "Gebruik subdomein";
$_LANG['orderyears'] = "Jaar/jaren";
$_LANG['orderyourinformation'] = "Uw gegevens";
$_LANG['orderyourorder'] = "Uw order";
$_LANG['organizationname'] = "Organisatie naam";
$_LANG['outofstock'] = "Niet op voorraad";
$_LANG['outofstockdescription'] = "Momenteel hebben we dit item niet meer op voorraad, bestellingen worden zolang opgeschort totdat er weer voorraad is. Neem voor meer informatie contact met ons op.";
$_LANG['page'] = "Pagina";
$_LANG['pageof'] = "van";
$_LANG['please'] = "Aub";
$_LANG['pleasewait'] = "Even geduld aub...";
$_LANG['presalescontactdescription'] = "Hier kunt u al uw pre-sales vragen opgeven";
$_LANG['previouspage'] = "Vorige pagina";
$_LANG['proformainvoicenumber'] = "Proforma factuur #";
$_LANG['promoexistingclient'] = "Om deze code te kunnen gebruiken dient u een actief product/service te hebben";
$_LANG['promoonceperclient'] = "Deze code kan per klant slechts één keer worden gebruikt";
$_LANG['pwstrengthfail'] = "Het door u opgegeven wachtwoord is niet sterk genoeg - geef aub een meer complex wachtwoord op";
...
$_LANG['serverstatusdescription'] = "Bekijk de live status info van onze servers";
$_LANG['serverstatusnoservers'] = "Er worden momenteel geen servers gemonitoord";
...
$_LANG['ssladmininfo'] = "Administratieve contact informatie";
...
$_LANG['sslconfigcompletedetails'] = "Uw SSL certificaat configuratie is nu voltooid en naar de certificaat autoriteit opgestuurd ten behoeve van de validatie. U zult kort na de goedkeuring een email van hun ontvangen.";
$_LANG['sslconfsslcertificate'] = "SSL certificaat configuratie";
$_LANG['sslcsr'] = "CSR";
$_LANG['sslerrorapproveremail'] = "U moet een email adres ten behoeve van de goedkeuring kiezen";
$_LANG['sslerrorentercsr'] = "U moet uw certificaat ondertekeningsverzoek opgeven (CSR)";
$_LANG['sslerrorselectserver'] = "U moet uw server type opgeven";
$_LANG['sslinvalidlink'] = "Ongeldige link opgegeven.";
$_LANG['sslorderdate'] = "Order datum";
$_LANG['sslserverinfo'] = "Server informatie";
...
$_LANG['statsnumproducts'] = "Aantal producten/services";
$_LANG['statsnumreferredsignups'] = "Aantal verwijzing aanmeldingen";
$_LANG['statsnumtickets'] = "Aantal support tickets";
$_LANG['submitticketdescription'] = "Probleem ticket opgeven";
$_LANG['supportclickheretocontact'] = "Klik hier om contact met ons op te nemen";
$_LANG['supportpresalesquestions'] = "Als u enige pre-sales vragen heeft";
$_LANG['supportticketinvalid'] = "Fout opgetreden. Het gevraagde ticket kon niet worden gevonden.";
...
$_LANG['supportticketsclientemail'] = "Email adres";
...
$_LANG['supportticketserrornoemail'] = "U heeft uw email adres niet opgegeven";
...
$_LANG['supportticketsfilenotallowed'] = "Het bestand wat u wilde uploaden is niet toegestaan.";
$_LANG['supportticketsheader'] = "Als u geen oplossing voor uw problemen in onze kennisbank kunt vinden, dan kunt u een ticket opgeven door hieronder de betreffende afdeling te selecteren.";
...
$_LANG['supportticketsstatuscloseticket'] = "Als het is opgelost, klik dan hier om de ticket te sluiten";
...
$_LANG['supportticketssubmitticket'] = "Ticket opgeven";
$_LANG['supportticketssystemdescription'] = "Het support ticket systeem geeft ons de mogelijkheid om snel op uw problemen en vragen te reageren. Als we op uw support ticket reageren dan wordt u daarvan via email op de hoogte gesteld.";
$_LANG['supportticketsticketattachments'] = "Bijlages";
$_LANG['supportticketsticketcreated'] = "Ticket aangemaakt";
$_LANG['supportticketsticketcreateddesc'] = "Uw ticket is met succes aangemaakt. Er is een email met de ticket informatie naar uw adres gestuurd. Als u wilt kunt u de ticket nu ook bekijken.";
...
$_LANG['telesigninvalidpin'] = "De door u opgeven PIN is ongeldig !";
$_LANG['telesigninvalidpin2'] = "De door u opgeven PIN is ongeldig.";
...
$_LANG['upgradechoosepackage'] = "Kies uit onderstaande opties het pakket waar u uw huidige pakket naar wilt gaan upgraden/downgraden.";
...
$_LANG['pwresetemailnotfound'] = "Er is geen klantenaccount voor het door u opgegeven emailadres gevonden";
...
$_LANG['pwresetkeyinvalid'] = "De herstel link welke u heeft gevolgd is ongeldig. Probeer het nog eens.";
$_LANG['pwresetkeyexpired'] = "De herstel link welke u heeft gevolgd is verlopen. Probeer het nog eens.";
$_LANG['pwresetvalidationsuccess'] = "Wachtwoord herstel is gelukt";
$_LANG['pwresetvalidationsuccessdesc'] = "Uw wachtwoord is hersteld en de nieuwe inloggegevens zijn naar u per email toegestuurd.";
...
$_LANG['promoappliedbutnodiscount'] = "De promotiecode dat u invoerde is aan uw bestelling toegevoegd. Echter in uw bestelling zijn op dit moment geen producten/services waarvoor deze code geldt - raadpleeg onze promotiecode voorwaarden";

$_LANG['upgradeerroroverdueinvoice'] = "U kunt voor dit product op dit moment geen up- of downgrade doen, omdat er al een factuur is aangemaakt voor de aankomende hernieuwing.<br /><br />Om toch door te kunnen gaan, dient u eerst de openstaande factuur te voldoen. Hierna kunt u direct de up- of downgrade verrichten. Het verschil in de kosten worden u zoals gebruikelijk berekend of gecrediteerd.";

$_LANG['subaccountactivate'] = "Activeer sub-Account";
$_LANG['subaccountactivatedesc'] = "Kies om als een sub-account in te stellen met klantaccount toegang";
$_LANG['subaccountpermissions'] = "Sub-account Permissies";
...
$_LANG['subaccountpermstickets'] = "Bekijk en open support tickets";
...
$_LANG['subaccountpermissiondenied'] = "U heeft geen toestemming de betreffende pagina te openen";
$_LANG['subaccountallowedperms'] = "Uw permissies zijn:";
...
$_LANG['domainrenewals'] = "Domein hernieuwingen";
$_LANG['domaindaysuntilexpiry'] = "Dagen tot de vervaldatum";
$_LANG['domainrenewalsnoneavailable'] = "Er zijn in uw account geen domeinen beschikbaar voor vernieuwing";
$_LANG['domainrenewalspastgraceperiod'] = "Voorgaande hernieuw periode";
$_LANG['domainrenewalsingraceperiod'] = "Laatste verandering tot de hernieuwing!";
...
$_LANG['twitterfollowuswhy'] = "om zo uptodate te blijven met onze laatste nieuwtjes &amp; aanbiedingen";

$_LANG['chatlivehelp'] = "Live Help";

$_LANG['domainrelease'] = "Domein opheffen";
$_LANG['domainreleasedescription'] = "Geef hier een nieuwe TAG op om uw domein naar een andere registar te verhuizen";
$_LANG['domainreleasetag'] = "Nieuwe registar tag";

# Ajax Order Form

$_LANG['orderformtitle'] = "Order formulier";
...
$_LANG['cartenterpromo'] = "Geef de promotie code op";
$_LANG['cartremovepromo'] = "Verwijder promotie code";
...
$_LANG['dlinvalidlink'] = "Ongeldige link opgevolgd. Neem contact met de Ondersteuning afdeling aub";

$_LANG['domaindnsmanagementlaunch'] = "DNS manager starten";
$_LANG['domainemailforwardinglaunch'] = "Mail doorsturing manager starten";
...
$_LANG['noquotes'] = "Op dit moment zijn er geen offertes in uw account opgeslagen.<br />Open een ticket om een offerte aan te vragen.";
...
$_LANG['invoicesubscriptionpayment'] = "Creeer een geautomatiseerde terugkerende abonnement";

$_LANG['invoicepaymentpendingreview'] = "Dank u! Uw betaling is gelukt en zal zo spoedig mogelijk aan uw factuur worden toegevoegd, zodra 2CheckOut's controle is voltooid.<br /><br />This can take up to a few hours so your patience is appreciated.";

$_LANG['step'] = "Stap %s";
$_LANG['cartdomainexists'] = "Dit domein is in onze database al bekend en kan dus niet opnieuw worden aangevraagd";
...
$_LANG['recurringpromodesc'] = "Deze actiecode bevat ook een %s terugkerende korting<br />(Deze korting wordt tevens gebruikt voor toekomstige hernieuwingen van de totale prijs voor dit product)";
...
$_LANG['cancelrequestdomaindesc'] = "Je hebt tevens een actieve domein registratie gerelateerd aan dit product<br />De volgende verlenging is op %s. Kosten %s per %s jaar<br /><br />Indien je dit domein ook wilt annuleren aan het eind van de registratieperiode, klik dan hieronder.";
...
$_LANG['cartqtyenterquantity'] = "Wil je meer dan 1 stuk? Vul hier het aantal in:";
...
$_LANG['promonewsignupsonly'] = "Deze promotie code is alleen geldig voor nieuwe klanten";
...
$_LANG['captchatitle'] = "Spam Bot Verificatie";
$_LANG['captchaverify'] = "Neem de karakters zoals hier onder aangeduid over en vul ze in het onderstaande text veld in. Dit om automatische aanmeldingen te voorkomen.";
...
$_LANG['bundlereqsnotmet'] = "Pakket vereisten niet bereikt";
$_LANG['bundlewarningpromo'] = "Deze aanbieding is niet geldig in combinatie met andere aanbiedingen";
$_LANG['bundlewarningproductcycle'] = "Deze aanbieding vereist een betalingstermijn van '%s' for product %s to qualify";
...
$_LANG['bundlewarningdomainreq'] = "Om voor deze aanbieding in aanmerking te komen dient u voor %s een domein te registreren of verhuizen";
$_LANG['bundlewarningdomaintld'] = "Om voor deze aanbieding in aanmerking te komen dient u voor %s een domein te registreren of verhuizen met extensie '%s'";
$_LANG['bundlewarningdomainregperiod'] = "Om voor deze aanbieding in aanmerking te komen dient u voor %s een domein te registreren of verhuizen voor '%s'";
...
$_LANG['navservicesorder'] = "Bestel Dienst";
...
$_LANG['navopenticket'] = "Maak Ticket";
$_LANG['navmanagecc'] = "Beheer Credit Card";
$_LANG['navemailssent'] = "Emails Verstuur";
...
$_LANG['clientareahomeorder'] = "Bezoek ons bestelformulier voor een overzicht van onze producten en diensten. Indien u al klant bent kunt u hier ook eventuele uitbreidingen bestellen.";
...
$_LANG['ccexpiringsoondesc'] = "Uw credit car verloopt binnenkort. Wij verzoeken u vriendelijk om %suw gegevens aan te vernieuwen%s";
$_LANG['availcreditbal'] = "Beschikbaar Saldo";
$_LANG['availcreditbaldesc'] = "Uw huidige saldo bedraagt %s. Dit zal automatisch worden verrekend met eventuele nieuwe facturen";
...
$_LANG['supportticketsnoneopen'] = "Er zijn momenteel geen open support tickets";
$_LANG['invoicesnoneunpaid'] = "Op dit moment zijn er geen openstaande facturen";

$_LANG['registerdisablednotice'] = "Om te registreren dient u eerst een <strong><a href=\"cart.php\">order</a></strong> te plaatsen.";
...
$_LANG['domainlockingexp'] = "Activeer Domein Lock om te voorkomen dat u domein gekaapt word zonder uw toestemming.";
...
$_LANG['addfundsdescription'] = "Stort geld op uw account om kleine transacties te voorkomen en om uw facturen automatisch te betalen.";
...
$_LANG['domaincheckerenterdomain'] = "Start uw web hosting ervaring met ons door het invullen van het door u gewenste domeinnaam of bestel alleen hosting...";
...
$_LANG['contactus'] = "Neem contact op ment ons";

$_LANG['opennewticket'] = "Open Ticket";
$_LANG['searchtickets'] = "Geef Ticket # of Onderwerp";
