...
$_LANG['clientareacpanellink'] = "Login no cPanel";
...
$_LANG['clientareawebmaillink'] = "Login no Webmail";
$_LANG['clientareawhmlink'] = "Login no WHM";
...
$_LANG['domaineppcodedesc'] = "É necessário obter a autorização do actual registador";
...
$_LANG['pwresetvalidationsuccessdesc'] = "Sua password já foi renovada e os detalhes de login novamente enviados para si.";
...
$_LANG['recaptcha-invalid-site-private-key'] = "Ocorreu um erro, por favor contacte o suporte (error code: cap1)";
$_LANG['recaptcha-invalid-request-cookie'] = "Ocorreu um erro, por favor contacte o suporte (error code: cap2)";
